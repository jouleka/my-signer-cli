...
RSpec.describe Mysigner::Export::Exporter do
  ...
  describe "#initialize" do
    ...
    it "raises error if archive doesn't exist" do
      ...
      }.to raise_error(Mysigner::Export::Exporter::ExportError, /Archive not found/)
    end
    ...
    it "raises error if archive is not a directory" do
      ...
      }.to raise_error(Mysigner::Export::Exporter::ExportError, /Invalid archive/)
    end
  ...
  describe "#export!" do
    ...
    it "raises error if xcodebuild fails" do
      ...
      expect {
        exporter.export!(method: :appstore, team_id: 'ABC123')
      }.to raise_error(Mysigner::Export::Exporter::ExportError, /Export failed/)
    end
    ...
    it "raises error if .ipa file not found after export" do
      ...
      expect {
        exporter.export!(method: :appstore, team_id: 'ABC123')
      }.to raise_error(Mysigner::Export::Exporter::ExportError, /.ipa file not found/)
    end

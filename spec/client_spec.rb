...
RSpec.describe Mysigner::Client do
  ...
  describe '#test_connection' do
    ...
    it 'raises ConnectionError if connection fails' do
      ...
      end.to raise_error(Mysigner::ConnectionError, /Connection failed/)
    end
  end
  ...
  describe 'error handling' do
    it 'raises UnauthorizedError for 401 responses' do
      ...
      end.to raise_error(Mysigner::UnauthorizedError, /Invalid token/)
    end
    ...
    it 'raises ForbiddenError for 403 responses' do
      ...
      end.to raise_error(Mysigner::ForbiddenError, /Insufficient permissions/)
    end
    ...
    it 'raises NotFoundError for 404 responses' do
      ...
      end.to raise_error(Mysigner::NotFoundError, /Organization not found/)
    end
    ...
    it 'raises ValidationError for 422 responses with details' do
      ...
      end.to raise_error(Mysigner::ValidationError) do |error|
    ...
    it 'raises RateLimitError for 429 responses' do
      ...
      expect do
        client.get('/api/v1/organizations')
      end.to raise_error(Mysigner::RateLimitError) do |error|
    ...
    it 'raises ServerError for 500 responses' do
      ...
      expect do
        client.get('/api/v1/organizations')
      end.to raise_error(Mysigner::ServerError, /Something went wrong/)
    end
    ...
    it 'raises TimeoutError for timeout errors' do
      ...
      expect do
        client.get('/api/v1/organizations')
      end.to raise_error(Mysigner::TimeoutError, /Request timeout/)
    end
  end
end

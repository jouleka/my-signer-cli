...
RSpec.describe Mysigner::CLI do
  ...
  describe "#device add" do
    context "when not logged in" do
      it "shows error and exits" do
        expect {
          capture_output { Mysigner::CLI.start(['device', 'add', 'iPhone', '12345']) }
        }.to raise_error(SystemExit)
      end
    end
    ...
    context "when logged in" do
      ...
      it "shows error when missing arguments" do
        expect {
          output = capture_output { Mysigner::CLI.start(['device', 'add', 'OnlyName']) }
      ...
      it "shows error for unknown action" do
        expect {
          output = capture_output { Mysigner::CLI.start(['device', 'unknown']) }
  ...
  describe "#device update" do
    ...
    context "when logged in" do
      ...
      it "shows error when missing arguments" do
        expect {
          output = capture_output { Mysigner::CLI.start(['device', 'update', '1']) }
  ...
  describe "#profile download" do
    context "when not logged in" do
      it "shows error and exits" do
        expect {
          capture_output { Mysigner::CLI.start(['profile', 'download', '1']) }
        }.to raise_error(SystemExit)
      end
    end
    ...
    context "when logged in" do
      ...
      after do
        ...
        File.delete("Test_Profile.mobileprovision") if File.exist?("Test_Profile.mobileprovision")
        File.delete("custom_output.mobileprovision") if File.exist?("custom_output.mobileprovision")
      end
      ...
      it "downloads a profile" do
        ...
        output = capture_output { Mysigner::CLI.start(['profile', 'download', '1']) }
      ...
      it "handles not found error" do
        ...
        expect {
          output = capture_output { Mysigner::CLI.start(['profile', 'download', '999']) }
      ...
      it "shows error when missing ID" do
        expect {
          output = capture_output { Mysigner::CLI.start(['profile', 'download']) }
      ...
      it "shows error for unknown action" do
        expect {
          output = capture_output { Mysigner::CLI.start(['profile', 'unknown']) }
          expect(output).to include("Unknown action: unknown")
        }.to raise_error(SystemExit)
      end
    end
  ...
  describe "#profile delete" do
    context "when not logged in" do
      it "shows error and exits" do
        expect {
          capture_output { Mysigner::CLI.start(['profile', 'delete', '1']) }
        }.to raise_error(SystemExit)
      end
    end
    ...
    context "when logged in" do
      ...
      it "deletes a profile after confirmation" do
        ...
        output = capture_output { Mysigner::CLI.start(['profile', 'delete', '1']) }
      ...
      it "handles not found error" do
        ...
        expect {
          capture_output { Mysigner::CLI.start(['profile', 'delete', '999']) }
        }.to raise_error(SystemExit)
      end

      it "shows error when missing ID" do
        expect {
          output = capture_output { Mysigner::CLI.start(['profile', 'delete']) }
  ...
  describe "#certificate download" do
    context "when not logged in" do
      it "shows error and exits" do
        expect {
          capture_output { Mysigner::CLI.start(['certificate', 'download', '1']) }
        }.to raise_error(SystemExit)
      end
    end
    ...
    context "when logged in" do
      ...
      after do
        # Clean up downloaded test files
        File.delete("Test_Certificate.cer") if File.exist?("Test_Certificate.cer")
        File.delete("custom_output.cer") if File.exist?("custom_output.cer")
      end
      ...
      it "downloads a certificate" do
        ...
        output = capture_output { Mysigner::CLI.start(['certificate', 'download', '1']) }
      ...
      it "handles not found error" do
        ...
        expect {
          output = capture_output { Mysigner::CLI.start(['certificate', 'download', '999']) }
      ...
      it "shows error when missing ID" do
        expect {
          output = capture_output { Mysigner::CLI.start(['certificate', 'download']) }
      ...
      it "shows error for unknown action" do
        expect {
          output = capture_output { Mysigner::CLI.start(['certificate', 'unknown']) }
          expect(output).to include("Unknown action: unknown")
        }.to raise_error(SystemExit)
      end
    end

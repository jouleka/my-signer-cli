  ...
  class CLI < Thor
    ...
    def ship(target)
      ...
      begin
        # STEP 1: BUILD
        say "=" * 80, :cyan
        say "STEP 1: Building Archive", :cyan
        say "=" * 80, :cyan
        say ""
        ...
        # STEP 3: UPLOAD
        say "=" * 80, :cyan
        say "STEP 3: Uploading to TestFlight", :cyan
        say "=" * 80, :cyan
        say ""
        ...
        say "=" * 80, :green
        say ""
        say "What happened:", :bold
        say "  ✅ Built archive from your project"
        say "  ✅ Exported IPA for distribution"
        say "  ✅ Uploaded to App Store Connect"
        say ""
        say "Next steps:", :cyan
        say "  • Wait 5-15 minutes for processing"
        say "  • Open App Store Connect to distribute to testers"
        say "  • Check TestFlight for your build"
        say ""
